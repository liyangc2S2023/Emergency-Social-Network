...
beforeEach(async () => {
  ...
  await EmergencyContact.addEmergencyContacts('user1', 'user2', Date.now() + 1000);
  await EmergencyContact.addEmergencyContacts('user1', 'user3', Date.now() + 2000);
  await EmergencyContact.addEmergencyContacts('user2', 'user4', Date.now() + 3000);
});
...
test('addEmergencyContacts', async () => {
  await EmergencyContact.addEmergencyContacts('user1', 'user4', Date.now() + 4000);
  const emergencyContacts = await EmergencyContact.getEmergencyContact('user1');
